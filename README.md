![New_BulkRenamer_Logo_256x](https://github.com/TylersHub/BulkRenamer/assets/125721050/d27a5002-2c3c-4f38-9099-4a1609e018ee)
# BulkRenamer

BulkRenamer is a Windows application that allows you to rename multiple files simultaneously. To use the tool, enter the current name of the file(s) and enter the new name that will replace it. Next, choose the directory in which the files are located. There are different settings available, the most important being whether the current name refers to the entire file name or only part of the file name. Other settings include choosing the file type, deciding whether to apply renaming to only the current directory or all child directories, and including the option to rename folders with the same name.
